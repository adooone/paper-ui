...
| [014-SURFACE_SYSTEM.md](./014-SURFACE_SYSTEM.md) | 🚧 In Progress | Decouple surface fill from texture: shared getSurfaceStyles helper, per-texture shade, soft accent washes (Card first) |
